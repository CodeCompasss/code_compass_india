...
export default function Mission() {
  // Sample team data - in a real app, this would come from your backend
  const teamMembers: TeamMember[] = [
    {
      id: 1,
      name: 'Alex Johnson',
      role: 'Lead Developer & Founder',
      bio: 'Full-stack developer with 8+ years experience building scalable web applications and developer tools.',
    ...
    },
    {
      ...
      bio: 'UI/UX specialist focused on creating intuitive developer experiences and beautiful, accessible interfaces.',
      avatar: 'https://images.unsplash.com/photo-1494790108755-2616b612b3fe?ixlib=rb-4.0.3&w=200&h=200&fit=crop&crop=face',
    ...
    },
    {
      ...
      bio: 'Systems engineer specializing in scalable infrastructure, API design, and performance optimization.',
            ...
            {teamMembers.length > 0 ? (
              ...
              >
                ...
                <p className="text-gray-500 dark:text-gray-500 max-w-md mx-auto">
                  Team member information will be displayed here once the backend integration is configured.
                </p>
              </motion.div>
            )}
          </div>
